...
enum GPIOB_ENUM	{
						/*-----------------------PIN 0--------------------------*/
								...
								GPIOB_0_PUPD_SET	= 	GPIO_PUPDR_PUPD0_1,
						...
						/*-----------------------PIN 1--------------------------*/
								...
								GPIOB_1_PUPD_SET 	= 	GPIO_PUPDR_PUPD1_1,
						...
						/*-----------------------PIN 2--------------------------*/
								...
								GPIOB_2_PUPD_SET 	= 	GPIO_PUPDR_PUPD2_1,
						...
						/*-----------------------PIN 3--------------------------*/
								...
								GPIOB_3_PUPD_SET	= 	GPIO_PUPDR_PUPD3_1,
...
enum GPIOC_ENUM	{
						/*-----------------------PIN 0--------------------------*/
								...
								/*---------------SET BITS-------------------*/
								GPIOC_0_MOD_SET 	= 	GPIO_MODER_MODE0_0,
						...
						/*-----------------------PIN 1--------------------------*/
								...
								/*---------------SET BITS-------------------*/
								GPIOC_1_MOD_SET 	= 	GPIO_MODER_MODE1_0,
